...
class documentos:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&documentos')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('documentos', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/documents/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Documentos'),
            callback=self.run,
